...
export class TradeEngine {
  ...
  async onSignal(signal) {
    ...
    try {
      ...
      await this.hyperliquid.updateLeverage(signal.hyperSymbol, CONFIG.hyperliquid.leverage);
      ...
      const rawSize = computeOrderSize({ withdrawableBalance, entryPrice });
      ...
      const messageId = await sendTelegram([
        ...
        `Leverage: ${CONFIG.hyperliquid.leverage}x`
      ].join('\n'));
